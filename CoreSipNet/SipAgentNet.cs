...
namespace CoreSipNet
{
    ...
    */
    ...
    public class CORESIP_CallInfo
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = SipAgentNet.CORESIP_MAX_BSS_LENGTH * 3 + 1)]
    ...
    public class CORESIP_CallOutInfo
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = SipAgentNet.CORESIP_MAX_CALLID_LENGTH + 1)]
        public string CallIdToReplace;      //Call id de la llamada a reemplazar
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = SipAgentNet.CORESIP_MAX_TAG_LENGTH + 1)]
    ...
    public class CORESIP_WG67_Subscription_Info
    {
        ...
        public struct CORESIP_WG67SessionsInfo
        {
            ...
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = SipAgentNet.CORESIP_MAX_SESSTYPE_LENGTH + 1)]
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = SipAgentNet.CORESIP_MAX_BODY_LEN)]
    ...
    public class CORESIP_WG67Notify_Body_Config
    {
        ...
        public struct CORESIP_WG67NotifySessionsInfo
        {
            ...
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = SipAgentNet.CORESIP_MAX_URI_LENGTH)]
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = SipAgentNet.CORESIP_MAX_WG67_NOTIFY_SESSIONS)]
    ...
    public class SipAgentNet
    {
        ...
        */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_Get_Ed137_version(out char ED137Radioversion, out char ED137Phoneversion, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetSipPort(int port, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetParams([In] int MaxForwards, [In] int Options_answer_code, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetJitterBuffer(uint adaptive, uint initial_prefetch, uint min_prefetch, uint max_prefetch, uint discard, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_CreateRdRxPort([In] CORESIP_RdRxPortInfo info, string localIp, out int rdRxPort, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_DestroyRdRxPort(int rdRxPort, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_CallPtt_Delayed(int call, [In] CORESIP_PttInfo info, uint delay_ms, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SendWG67Subscription(int accId, string dest_uri, int expires, int noRefresh, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetWG67SubscriptionParameters(int accId, string dest_uri, int noRefresh, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_Set_WG67_Notifier_Parameters(int notify_enabled, int manual, int minimum_expires, int maximum_expires, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_Set_WG67_notify_status(int accId, string subscriberUri, [In] CORESIP_WG67Notify_SubscriptionState_Config subsState,
        ...
        static extern int CORESIP_Get_GRS_WG67SubscriptionsList(int accId, out int nSubscriptions, ref IntPtr WG67Subscriptions, out CORESIP_Error error);
	     ...
	     */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetTipoGRS(int accId, uint Flag, int on, CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetGRSParams(int accId, string RdFr, [In] int Tj1, [In] int Ts1, [In] int Ts2,
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_GRS_Force_Ptt_Mute(int call, CORESIP_PttType PttType, ushort PttId, bool on, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_GRS_Force_Ptt(int call, CORESIP_PttType PttType, ushort PttId, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_GRS_Force_SCT(int call, bool on, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_Force_PTTS(int call, bool on, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetImpairments(int call, [In] CORESIP_Impairments impairments, CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetCallParameters(int call, [In] int disableKeepAlives, [In] int forced_cld, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SetConfirmPtt(int call, bool val, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_GetNetworkDelay(int call, [In] uint delay_ms, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SendToneToCall(int call, [In] uint frequency, float volume_dbm0, int on, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SendNoiseToCall(int call, float volume_dbm0, int on, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SendPinkNoiseToCall(int call, float volume_dbm0, int on, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SendDTMF(int call, [In] CORESIP_tone_digit_map digit_map, uint count, CORESIP_tone_digit[] digits, float volume_dbm0, out CORESIP_Error error);
        ...
        /**
            ...
            */
        [DllImport(coresip, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
        static extern int CORESIP_SendSELCAL(int call, string selcalValue, out CORESIP_Error error);
        ...
        public static void Init(SipAgentNetSettings Settings, string accId, string ip, uint port, uint max_calls = 32, string proxyIP = null)
        {
            ...
            if (!IsInitialized)
            {
                ...
                //if (CORESIP_SetParams(0, 200, out err) != 0)
                //{
                //    throw new Exception(err.Info);
                //}
...
//#if _TRACEAGENT_
//            _Logger.Debug("Entrando en SipAgentNet.SetLogLevel {0}", level.Name);
//#endif
...
//#if _TRACEAGENT_
//            _Logger.Debug("Saliendo de SipAgentNet.SetLogLevel");
//#endif
//        }
        /// <summary>
        /// 
        ...
        public static void DestroyAccounts()
        {
            foreach (int id in _Accounts.Values)
            {
                ...
                {
                    throw new Exception("SipAgentNet.DestroyAccounts: " + err.Info);
                }
            }
            _Accounts.Clear();
        }
        ...
        public static int AddSndDevice(CORESIP_SndDevType type, int inDevId, int outDevId)
        {
            ...
            {
                throw new Exception("SipAgentNet.AddSndDevice: " + err.Info);
            }
        ...
        public static int CreateWavPlayer(string file, bool loop)
        {
            ...
            {
                throw new Exception("SipAgentNet.CreateWavPlayer Error: " + err.Info);
            }
            return wavPlayer;
        }
        /// <summary>
        ...
        public static void DestroyWavPlayer(int wavPlayer)
        {
            ...
            {
                throw new Exception("SipAgentNet.DestroyWavPlayer Error: " + err.Info);
            }
        }
        ...
        public static int CreateWavRecorder(string file)
        {
            ...
            {
                throw new Exception("SipAgentNet.CreateWavRecorder Error: " + err.Info);
            }
            return wavRecorder;
        }
        ...
        public static void DestroyWavRecorder(int wavRecorder)
        {
            ...
            {
                throw new Exception("SipAgentNet.DestroyWavRecorder Error: " + err.Info);
            }
#if _TRACEAGENT_
            _Logger.Debug("Saliendo de SipAgentNet.DestroyWavRecorder");
#endif
        }
...
//        {
//#if _TRACEAGENT_
//            _Logger.Debug("Entrando en SipAgentNet.CreateRdRxPort {0}, {1}", rs.ToString(), localIp);
//#endif
...
//            }
//#if _TRACEAGENT_
//            _Logger.Debug("Saliendo de SipAgentNet.CreateRdRxPort");
//#endif
...
//        }
        ...
        public static void DestroyRdRxPort(int port)
        {
            ...
            {
                throw new Exception("SipAgentNet.DestroyRdrxPort Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static int CreateSndRxPort(string name)
        {
            ...
            {
                throw new Exception("SipAgentNet.CreateSndRxPort Error: " + err.Info);
            }
            return sndRxPort;
        }
        /// <summary>
        ...
        public static void DestroySndRxPort(int port)
        {
            ...
            {
                throw new Exception("SipAgentNet.DestroySndRxPort: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void MixerLink(int srcId, int dstId)
        {
            ...
            {
                throw new Exception("SipAgentNet.MixerLink Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void MixerUnlink(int srcId, int dstId)
        {
            ...
            {
                throw new Exception("SipAgentNet.MixerUnlink Error: " + err.Info);
            }
        }
        /// <summary>
        ...
        public static void SendToRemote(int sndDevId, string id, string ip, uint port)
        {
            ...
            {
                throw new Exception("SipAgentNet.SendToRemote Error: " + err.Info);
            }
        }
        /// <summary>
        ...
        public static void ReceiveFromRemote(string localIp, string mcastIp, uint mcastPort)
        {
            ...
            {
                throw new Exception("SipAgentNet.ReceiveFromRemote Error: " + err.Info);
            }
        }
        /// <summary>
        ...
        public static void UnsendToRemote(int sndDevId)
        {
            ...
            {
                throw new Exception("SipAgentNet.UnsendToRemote: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void SetVolume(int id, int volume)
        {
            ...
            {
                throw new Exception("SipAgentNet.SetVolume Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static int GetVolume(int id)
        {
            ...
            {
                throw new Exception("SipAgentNet.GetVolume Error: " + err.Info);
            }
            return volume;
        }
        /// <summary>
        ...
        public static int MakeTlfCall(string accId, string dst, string referBy, CORESIP_Priority priority, CORESIP_CallFlags flags)
        {
            ...
            {
                throw new Exception("SipAgentNet.MakeTlfCall Error: " + err.Info);
            }
            return callId;
        }
        /// <summary>
        ...
        public static int MakeLcCall(string accId, string dst, CORESIP_CallFlags flags)
        {
            ...
            if (CORESIP_CallMake(info, outInfo, out callId, out err) != 0)
            {
                throw new Exception("SipAgentNet.MakeLcCall Error: " + err.Info);
            }
            return callId;
        }
        /// <summary>
...
//            info.bss_method = bss_method;
            ...
            if (CORESIP_CallMake(info, outInfo, out callId, out err) != 0)
            {
                throw new Exception("SipAgentNet.MakeRdCall: [" + outInfo.DstUri + "]" + err.Info);
            }
            return callId;
        }
        /// <summary>
        ...
        public static int MakeMonitoringCall(string accId, string dst, CORESIP_CallType type, CORESIP_CallFlags flags)
        {
            ...
            if (CORESIP_CallMake(info, outInfo, out callId, out err) != 0)
            {
                throw new Exception("SipAgentNet.MakeMonitoringCall Error: " + err.Info);
            }
            return callId;
        }
        /// <summary>
        ...
        public static void HangupCall(int callId)
        {
            ...
            {
                throw new Exception("SipAgentNet.HangupCall Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void HangupCall(int callId, int code)
        {
            ...
            {
                throw new Exception("SipAgentNet.HangupCall_2: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        {
            AnswerCall(callId, response, false, 0, "");
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public static void AnswerCall(int callId, int response, bool addToConference, int reasonCode, string reasonText)
        {
            CORESIP_Error err;
            if (CORESIP_CallAnswer(callId, response, addToConference ? 1 : 0, reasonCode, reasonText, out err) != 0)
            {
                throw new Exception("SipAgentNet.AnswerCall Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void HoldCall(int callId)
        {
            ...
            {
                throw new Exception("SipAgentNet.HoldCall Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void UnholdCall(int callId)
        {
            ...
            {
                throw new Exception("SipAgentNet.UnholdCall Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void TransferCall(int callId, int dstCallId, string dst)
        {
            ...
            {
                throw new Exception("SipAgentNet.TransferCall Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void PttOn(int callId, ushort pttId, CORESIP_PttType pttType, int PttMute)
        {
            ...
            {
                throw new Exception("SipAgentNet.PttOn Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void PttOff(int callId)
        {
            ...
            if (CORESIP_CallPtt(callId, info, out err) != 0)
            {
                throw new Exception("SipAgentNet.PttOff Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void AddCallToConference(int callId)
        {
            ...
            {
                throw new Exception("SipAgentNet.AddCallToConference Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void RemoveCallFromConference(int callId)
        {
            ...
            {
                throw new Exception("SipAgentNet.RemoveCallFromConference Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void SendConfInfo(int callId, CORESIP_ConfInfo info)
        {
            ...
            {
                throw new Exception("SipAgentNet.SendConfInfo Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void SendInfo(int callId, string info)
        {
            ...
            {
                throw new Exception("SipAgentNet.SendInfo Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void SendOptionsMsg(string dst, out string callid)
        {
            ...
            if (CORESIP_SendOptionsMsg(dst, callid_, 0, out err) != 0)
            {
                throw new Exception("SipAgentNet.SendOptionsMsg Error: " + err.Info);
            }
        ...
        public static void TransferAnswer(string tsxKey, IntPtr txData, IntPtr evSub, int code)
        {
            ...
            {
                throw new Exception("SipAgentNet.TransferAnswer Error: " + err.Info);
            }
        }
        /// <summary>
        /// 
        ...
        public static void TransferNotify(IntPtr evSub, int code)
        {
            ...
            {
                throw new Exception("SipAgentNet.TransferNotify Error: " + err.Info);
            }
        }
...
//        {
//#if _TRACEAGENT_
//            _Logger.Debug("Entrando en SipAgentNet.WavToRemote {0}, {1}, {2}, {3}", file, id, ip, port);
//#endif
//            CORESIP_Error err = new CORESIP_Error();
//            WavRemoteEnd cb = new WavRemoteEnd(Wav2RemoteEnd);
//            CORESIP_Wav2RemoteStart(file, id, ip, port, ref cb, ref err);
//#if _TRACEAGENT_
//            _Logger.Debug("Saliendo de SipAgentNet.Wav2Remote");
//#endif
//        }
...
//        {
//#if _TRACEAGENT_
//            _Logger.Debug("Entrando en SipAgentNet.WavToRemoteEnd {0}", obj);
//#endif
//            CORESIP_Error err = new CORESIP_Error();
//            CORESIP_Wav2RemoteEnd(obj, ref err);
//            /** Meter un Evento.... */
//#if _TRACEAGENT_
//            _Logger.Debug("Saliendo de SipAgentNet.WavToRemoteEnd");
//#endif
//        }
        /// <summary>
        /// 
